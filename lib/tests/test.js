...
/** @type {MyORMContext<import("../../.github/chinook-setup/chinook-types.js").Message>} */
export const messageCtx = new MyORMContext(chinookAdapter, "Message", { allowTruncation: true });

/** @type {MyORMContext<import("../../.github/chinook-setup/chinook-types.js").Triangle>} */
export const triangleCtx = new MyORMContext(chinookAdapter, "Triangle", { allowTruncation: true });
...
messageCtx.onSuccess(onSuccess);
messageCtx.onFail(onFail);
triangleCtx.onSuccess(onSuccess);
triangleCtx.onFail(onFail);
...
async function doTests() {
    ...
    await messageCtx.truncate();
    await triangleCtx.truncate();
    await testSelects();
    await testInserts();
    await testUpdates();
    await testDeletes();
