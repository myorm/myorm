...
async function customTest() {
    ...
    const playlistsWithTracks = playlistsCtx
    ...
    console.log(`Music Playlists`, { totalNum: classicalPlaylists.length, playlist: classicalPlaylists[1], pTracks: classicalPlaylists[1].PlaylistTracks, track: classicalPlaylists[1].PlaylistTracks[0].Track });
    console.log(`Classical Playlists`, { totalNum: classicalPlaylists.length, playlist: classicalPlaylists[1], pTracks: classicalPlaylists[1].PlaylistTracks, track: classicalPlaylists[1].PlaylistTracks[0].Track });
    process.exit();
}
