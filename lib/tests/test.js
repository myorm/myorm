...
/** @type {MyORMContext<import("../examples/chinook-types.js").Track>} */
const trackCtx = new MyORMContext(pool, "Track");

/** @type {MyORMContext<import("../examples/chinook-types.js").TestTable>} */
const testTableCtx = new MyORMContext(pool, "TestTable", undefined, { allowTruncation: true });

/** @type {MyORMContext<import("../examples/chinook-types.js").TestTable & { Id?: number }>} */
