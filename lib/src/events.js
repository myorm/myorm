...
export class CommandListener extends EventEmitter {
     ...
     * @param {import('./context.js').SuccessHandler} callback Function that executes when a query command is executed on this context.
     */
     ...
     * Adds a listener event to the Connection Pool associated with this context 
     * whenever a Query command is successfully executed on the pool.
     * @param {import('./context.js').FailHandler} callback Function that executes when a query command is executed on this context.
     */
     ...
     * @param {import('./context.js').WarningHandler} callback 
     */
    onWarning(callback) {
