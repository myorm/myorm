...
export class CommandListener extends EventEmitter {
    ...
    emitQuerySuccess(detail) {
        return this.emit(`query-success-${this.tableName}`, this.#createDetailFromSuccessEvent(detail));
    }
    ...
    emitQueryFail(detail) {
        return this.emit(`query-fail-${this.tableName}`, this.#createDetailFromFailEvent(detail));
    }
    ...
    emitInsertSuccess(detail) {
        return this.emit(`insert-success-${this.tableName}`, this.#createDetailFromSuccessEvent(detail));
    }
    ...
    emitInsertFail(detail) {
        return this.emit(`insert-fail-${this.tableName}`, this.#createDetailFromFailEvent(detail));
    }
    ...
    emitUpdateSuccess(detail) {
        return this.emit(`update-success-${this.tableName}`, this.#createDetailFromSuccessEvent(detail));
    }
    ...
    emitUpdateFail(detail) {
        return this.emit(`update-fail-${this.tableName}`, this.#createDetailFromFailEvent(detail));
    }
    ...
    emitDeleteSuccess(detail) {
        return this.emit(`delete-success-${this.tableName}`, this.#createDetailFromSuccessEvent(detail));
    }
    ...
    emitDeleteFail(detail) {
        return this.emit(`delete-fail-${this.tableName}`, this.#createDetailFromFailEvent(detail));
    }
