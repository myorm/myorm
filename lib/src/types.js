 ...
 * @typedef {{[K in keyof T as T[K] extends AbstractModel|undefined ? `${K & string}_${keyof RecursiveAggregateProperties<T[K]> & string}` : K]: number}} RecursiveAggregateProperties
 */
...
/** 
 * Built data for executing a delete command. 
