...
export const DEFAULT_ESCAPE_CHARACTER__START = '`';
export const DEFAULT_ESCAPE_CHARACTER__END = '`';

/**
 * Separator used when aliasing columns that are of joined related tables.
 */
export const ALIAS_TABLE_SEPARATOR = '<|';

/**
 * Separator used when aliasing columns that are of aggregate
 */
export const ALIAS_AGGREGATE_SEPARATOR = '_';
