...
import { MyORMColumnDoesNotExistError, MyORMInvalidPropertyTypeError, MyORMSyntaxError } from './exceptions.js';
 ...
 * @param {Record<string, import('./schema.js').DescribedSchema>} schema
...
export class WhereBuilder {
    ...
    /** @type {Record<string, import('./schema.js').DescribedSchema>} */ #schema;
    ...
    _append(column, chain="WHERE") {
        // @ts-ignore
        this.#current = { table: this.#table, chain, property: column };
        this.#negated = chain.endsWith('NOT');
        return this;
    }
