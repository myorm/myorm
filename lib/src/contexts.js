...
export class MyORMContext {
     ...
     * @typedef {{[K in keyof TTableModel]: TTableModel[K] extends Types.AbstractModel|undefined ? GroupByCallbackModel<TTableModel[K]> : string}} GroupByCallbackModel
     */
     ...
     * 
     * __NOTE: This also works on keys from included tables, including one-to-many relationships, just reference the included model further until you reach the property desired.__
     * @param {(model: GroupByCallbackModel<Types.AllKeysRequired<TTableModel>>, aggregates: Types.Aggregates<TTableModel>) => string|string[]} groupByCallback
