...
export class MyORMContext {
     ...
     * @param {((model: AllKeysRequired<TTableModel>) => TAliasedType)} aliasModelCallback Callback that should return an object that would represent your desired aliased type. 
