 ...
 * @prop {(modelCallback: (model: {[K in keyof Required<OnlyAbstractModels<TTableModel>>]: HasOneCallbackConfig<TTableModel, K>}) => void) => ThenHasCallback<TTableModel>} andThatHasOne
 * @prop {(modelCallback: (model: {[K in keyof Required<OnlyAbstractModelArrays<TTableModel>>]: HasManyCallbackConfig<TTableModel, K>}) => void) => ThenHasCallback<TTableModel>} andThatHasMany
 */

/**
 * @template {AbstractModel} TTableModel
 * @callback HasOneCallback
 * @param {{[K in keyof OnlyAbstractModels<TTableModel>]: HasOneCallbackConfig<TTableModel, K>}} model
 */

/**
 * @template {AbstractModel} TTableModel
 * @callback HasManyCallback
 * @param {{[K in keyof OnlyAbstractModelArrays<TTableModel>]: HasManyCallbackConfig<TTableModel, K>}} model
 */
